	...
	public class PocoJsonSerializerStrategy : IJsonSerializerStrategy
	{
		...
		public virtual object deserializeObject(object value, Type type)
		{
			...
			else
			{
				...
				obj = ((!(value is long) || type != typeof(DateTime)) ? ((!typeof(IConvertible).IsAssignableFrom(type)) ? value : Convert.ChangeType(value, type, CultureInfo.InvariantCulture)) : ((object)new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddMilliseconds((long)value)));
			}
