...
namespace Org.BouncyCastle.Math
{
	...
	public class BigInteger
	{
		...
		public int IntValue
		{
			get
			{
				return (sign != 0) ? ((sign <= 0) ? (-magnitude[magnitude.Length - 1]) : magnitude[magnitude.Length - 1]) : 0;
			}
		}
		...
		{
			return (w < 32768) ? ((w < 128) ? ((w < 8) ? ((w < 2) ? ((w >= 1) ? 1 : ((w < 0) ? 32 : 0)) : ((w >= 4) ? 3 : 2)) : ((w < 32) ? ((w >= 16) ? 5 : 4) : ((w >= 64) ? 7 : 6))) : ((w < 2048) ? ((w < 512) ? ((w >= 256) ? 9 : 8) : ((w >= 1024) ? 11 : 10)) : ((w < 8192) ? ((w >= 4096) ? 13 : 12) : ((w >= 16384) ? 15 : 14)))) : ((w < 8388608) ? ((w < 524288) ? ((w < 131072) ? ((w >= 65536) ? 17 : 16) : ((w >= 262144) ? 19 : 18)) : ((w < 2097152) ? ((w >= 1048576) ? 21 : 20) : ((w >= 4194304) ? 23 : 22))) : ((w < 134217728) ? ((w < 33554432) ? ((w >= 16777216) ? 25 : 24) : ((w >= 67108864) ? 27 : 26)) : ((w < 536870912) ? ((w >= 268435456) ? 29 : 28) : ((w >= 1073741824) ? 31 : 30))));
		}
		...
		public BigInteger ModPow(BigInteger exponent, BigInteger m)
		{
			...
			return (exponent.sign <= 0) ? bigInteger3.ModInverse(m) : bigInteger3;
		}
		...
		public string ToString(int radix)
		{
			...
			case 2:
			{
				...
				{
					stringBuilder.Append((!TestBit(num)) ? '0' : '1');
				}
				break;
			}
			default:
		...
		public int GetLowestSetBit()
		{
			...
			int num3 = (((num2 & 0xFFFF) == 0) ? ((((uint)num2 & 0xFF0000u) != 0) ? 15 : 7) : ((((uint)num2 & 0xFFu) != 0) ? 31 : 23));
