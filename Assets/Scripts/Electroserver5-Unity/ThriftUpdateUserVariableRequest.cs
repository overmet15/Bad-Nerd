...
[Serializable]
public class ThriftUpdateUserVariableRequest : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftUpdateUserVariableRequest");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftUpdateUserVariableRequest(");
