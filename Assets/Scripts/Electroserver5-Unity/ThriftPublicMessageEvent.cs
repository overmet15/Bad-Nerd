...
[Serializable]
public class ThriftPublicMessageEvent : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftPublicMessageEvent");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftPublicMessageEvent(");
