...
[Serializable]
public class ThriftGetRoomsInZoneRequest : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftGetRoomsInZoneRequest");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftGetRoomsInZoneRequest(");
