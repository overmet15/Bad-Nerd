...
[Serializable]
public class ThriftUserEvictedFromRoomEvent : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftUserEvictedFromRoomEvent");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftUserEvictedFromRoomEvent(");
