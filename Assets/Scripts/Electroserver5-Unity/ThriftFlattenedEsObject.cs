...
[Serializable]
public class ThriftFlattenedEsObject : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftFlattenedEsObject");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftFlattenedEsObject(");
