...
[Serializable]
public class ThriftRequestDetails : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftRequestDetails");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftRequestDetails(");
