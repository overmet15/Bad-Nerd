...
[Serializable]
public class ThriftUpdateRoomVariableRequest : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftUpdateRoomVariableRequest");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftUpdateRoomVariableRequest(");
