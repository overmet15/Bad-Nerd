...
[Serializable]
public class ThriftCreateRoomVariableRequest : TBase
{
	[Serializable]
	public struct Isset
	{
	...
	{
		TStruct struc = new TStruct("ThriftCreateRoomVariableRequest");
	...
	{
		StringBuilder stringBuilder = new StringBuilder("ThriftCreateRoomVariableRequest(");
